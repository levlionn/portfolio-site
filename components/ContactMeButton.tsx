...
const ContactMeButton = ({ colour }: Props) => {
  return (
    <div className="max-w-s md:max-w-2xl mt-10 p-6 space-y-3 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden flex flex-col items-center ">
