...
const ExplainTheWebsite = () => {
  return (
    <div className="relative  h-52 rounded-lg bg-independence flex justify-center items-center">
      ...
      <div className="text-center">
        <p className="text-2xl font-semibold p-6  tracking-wide laptop:px-44 laptop:text-3xl text-white">
